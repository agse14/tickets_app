...
export let inlist;
export const options = ["Enfermero B\u00e1sico", "Enfermero Avanzado", "Cuidador", "Doctor", "Empleado", "Prueba COVID", "Otro", "Proveedor Rayos X", "Proveedor Laboratorio", "Proveedor Masajes"];
