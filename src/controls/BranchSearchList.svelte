  ...
  import { branches, addBranches } from './branches';
   ...
   let valueObject;
     ...
     onMount(() => {
           // Select2
          //  if(!inlist){
          //   jQuery("#select-branch"+baseId).select2();
          //   jQuery("#select-branch"+baseId).on("select2:select",function(e){
                  ...
                  var values = {
                    ...
                    <div class="{withStyle?'form-group':''}">
                      ...
                      <Select items={rows} bind:value={valueObject} on:clear={handleClear}></Select>
                          <!-- <select id="select-branch{baseId}" bind:value={value} class="form-control select2"  >
