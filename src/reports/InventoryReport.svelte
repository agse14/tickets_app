        ...
        async function processDocs(){
            ...
            docs.forEach((doc) => {
                    ...
                    if(filterValue == "" || temppastinventory.branches == filterValue){
                        ...
                        weeks[wId][temppastinventory.branches].total += temppastinventory.cost * temppastinventory.quantity;
                        ...
                        if(tmp[temppastinventory.products] == undefined){
                            tmp[temppastinventory.products] ={quantity:0, cost:0, total:0};
                        }

                        //tmp.push(temppastinventory);
                        tmp[temppastinventory.products].quantity += temppastinventory.quantity;
                        tmp[temppastinventory.products].cost = temppastinventory.cost;
                        tmp[temppastinventory.products].total += temppastinventory.cost * temppastinventory.quantity; 
                        console.log("sum prod "+temppastinventory.products,temppastinventory.cost, temppastinventory.quantity, tmp[temppastinventory.products].cost);
                    }
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">  
                            <div class="col-12"><h4 class="card-title">Reporte de compras</h4></div>
