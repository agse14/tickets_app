      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <!-- Switch para guardia compartida -->
            <div class="form-group row">
              <label class="col-md-4 col-form-label" for="sharedSwitch">
                Guardia compartida
              </label>
              <div class="col-md-8 d-flex align-items-center">
                <div class="custom-control custom-switch">
                  <input
                    ...
                    id="sharedSwitch"
                    bind:checked={values.shared}
                  />
                  <label class="custom-control-label" for="sharedSwitch">
                    {values.shared ? "Sí" : "No"}
                  </label>
                </div>
              </div>
