...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Reportes de enfermería semanales</h4>
                    {#if weekNew.length > 0}
                    <div class="row mb-4">
                        <div class="col"></div>
                                ...
                                {#if row.branch == filterValue}
                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            {#each weekNew as w}
                                                <div class="col mb-2">
                                                    <a href={"/addnursery/branch/"+row.branch+"/patientName/"+row.id} use:link class="avatar-title {nursery[row.id] != undefined && nursery[row.id][w.id] != undefined ? 'bg-soft-success text-success':'bg-soft-primary text-primary'} rounded text-center p-2">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <i class="mdi {nursery[row.id] != undefined && nursery[row.id][w.id] != undefined == true? 'mdi-check':'mdi-plus'}"></i>
                                                            </div>
                                                            <div class="col-12">
                                                                {w.date.weekdayShort} {w.date.day}
                                                            </div>
                                        ...
                                        <td>
                                            <button
                                                ...
                                                <br />
                                                <br />
                                                <a href={"/nursery_print/"+row.id+"/"+weekNew[0].id} use:link target="_blank" rel="noreferrer"
