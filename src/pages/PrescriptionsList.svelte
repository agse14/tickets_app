    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Administración Prescripción</h4>
                 {#if filterName != undefined && filterValue != undefined}
                ...
                {/if}
                <a use:link href="/prescriptions_history/patients/{filterValue ?? ""}" class="btn btn-light waves-effect">Ver historial</a>
                <a use:link href="/prescriptions_report/patients/{filterValue ?? ""}" class="btn btn-light waves-effect">Reporte para Impresión</a>
