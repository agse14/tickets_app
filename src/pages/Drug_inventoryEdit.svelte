...
<div class="page-content modal-body">
  <TitleBar title="Agregar Ingresos" base="Inventario" />
<form id="form">
  <div class="row">
...
<div class="card-body">
	...
	<div class="form-group row"><label for="#select-prescriptions" class="col-md-4 col-form-label">Medicamento</label>
	<div class="col-md-8"><PrescriptionsSearchList bind:value={values.prescriptions}  onSelect={(selected)=>{ values.patients = selected.patients ;}} />
	</div> </div>

	<div class="form-group row"><label for="dosis" class="col-md-4 col-form-label">Dosis a agregar</label><div class="col-md-8 input-group"><input class="form-control " type="number" bind:value={values.dosis} id="dosis"  /> </div> </div>

	<div class="form-group row"><label for="family" class="col-md-4 col-form-label">Familiar que entregó</label><div class="col-md-8 input-group"><input class="form-control " type="text" bind:value={values.family} id="family"  /> </div> </div>
