...
<div class="page-content">
  <TitleBar title="Agregar Foto" base="Inventario" />
<form id="form">
  <div class="row">
...
<div class="card-body">
	...
	<div class="form-group row"><label for="#select-patients" class="col-md-4 col-form-label">Huesped</label>
	<div class="col-md-8"><PatientsSearchList bind:value={values.patients}  />
	</div> </div>

	<div class="form-group row"><label for="photo" class="col-12 col-form-label">Foto</label> 
	<div class="col-12">  <ImageField bind:value={values.photo} node={values.id} baseId={'photo'} type={'file'} /> </div>
	</div>
