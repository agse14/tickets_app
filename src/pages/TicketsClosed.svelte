<script>
    ...
    function loadData() {
        ...
        datatable = jQuery("#tickets-closed-dt").DataTable({
            lengthMenu: [
                [10, 25, 50, -1],
            ...
            buttons: [
                {
                    extend: 'copy',
                    filename: 'Listado de Tickets Cerrados'
                },
                {
                    extend: 'excel',
                    filename: 'Listado de Tickets Cerrados'
        ...
        datatable
            .buttons()
            .container()
            .appendTo("#tickets-closed-dt_wrapper .col-md-6:eq(0)");
    }
            ...
            // .orderBy("createdDate", "desc")
             .onSnapshot(async (querySnapshot) => {
                ...
                querySnapshot.forEach((doc) => {
                    ...
                    // Coerce requestingArea to Number
                    if (tempTicket.requestingArea !== undefined && tempTicket.requestingArea !== null) {
                        tempTicket.requestingArea = Number(tempTicket.requestingArea);
                    } else {
                        tempTicket.requestingArea = 0;
                    }
                    ...
                    // Debug for Estancias tickets
                    if (tempTicket.requestingArea == 7) {
                        console.log('Ticket cerrado con Estancias:', tempTicket.id, tempTicket.requestingArea, tempTicket.branchName, tempTicket.branchId, tempTicket.requestingAreaName);
                    }
...
<div class="page-content">
    <TitleBar title="Tickets Cerrados" base="Administración" />

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Administración de Tickets Cerrados</h4>
                    {#if filterName != undefined && filterValue != undefined}
                        <FilterName
